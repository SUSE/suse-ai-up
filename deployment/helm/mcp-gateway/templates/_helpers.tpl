...
{{- if .Values.gateway.rbac.serviceAccount.create }}
{{- default (include "mcp-gateway.fullname" .) .Values.gateway.rbac.serviceAccount.name }}
{{- else }}
{{- default "default" .Values.gateway.rbac.serviceAccount.name }}
{{- end }}
{{- end }}
